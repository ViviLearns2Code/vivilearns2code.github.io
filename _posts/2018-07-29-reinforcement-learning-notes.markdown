...
The agent chooses actions at each time step and transitions from one state to the next until they arrive at a terminal state $$s_T$$. The sequence of states, actions and rewards $$s_0,a_0,r_1\ldots,s_T,r_T$$ defines an episode.  
